...
//+kubebuilder:rbac:groups=kuadra.kuadra.kuadrant.io,resources=awsaccounts,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=kuadra.kuadra.kuadrant.io,resources=awsaccounts/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=kuadra.kuadra.kuadrant.io,resources=awsaccounts/finalizers,verbs=update
